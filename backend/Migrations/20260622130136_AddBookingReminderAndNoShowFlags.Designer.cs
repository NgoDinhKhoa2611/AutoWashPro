...
namespace Auto_Wash.Migrations
{
    ...
    [Migration("20260622130136_AddBookingReminderAndNoShowFlags")]
    partial class AddBookingReminderAndNoShowFlags
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Auto_Wash.Data.Entities.Booking", b =>
                {
                    ...
                    b.HasIndex("PromoCodeId")
                        .HasDatabaseName("ix_bookings_promocodeid");
            ...
            modelBuilder.Entity("Auto_Wash.Data.Entities.Campaign", b =>
                {
                    ...
                    b.Property<decimal?>("BonusPointMultiplier")
                        .HasColumnType("decimal(4,2)")
                        .HasColumnName("bonuspointmultiplier");
                    ...
                    b.Property<int>("MinSpendValue")
                        .HasColumnType("integer")
                        .HasColumnName("minspendvalue");
                    ...
                    b.Property<int?>("TargetTierMinId")
                        .HasColumnType("integer")
                        .HasColumnName("targettierminid");
                    ...
                    b.HasIndex("TargetTierMinId")
                        .HasDatabaseName("ix_campaigns_targettierminid");
            ...
            modelBuilder.Entity("Auto_Wash.Data.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("Auto_Wash.Data.Entities.Campaign", "PromoCodeCampaign")
                        .WithMany("Bookings")
                        .HasForeignKey("PromoCodeId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_bookings_campaigns_promocodeid");
                    ...
                    b.Navigation("PromoCodeCampaign");
            ...
            modelBuilder.Entity("Auto_Wash.Data.Entities.Campaign", b =>
                {
                    b.HasOne("Auto_Wash.Data.Entities.Account", "CreatedByAccount")
                        .WithMany("CreatedCampaigns")
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_campaigns_accounts_createdby");

                    b.HasOne("Auto_Wash.Data.Entities.Tier", "TargetTierMin")
                        .WithMany()
                        .HasForeignKey("TargetTierMinId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_campaigns_tiers_targettierminid");

                    b.Navigation("CreatedByAccount");

                    b.Navigation("TargetTierMin");
                });
